# AI Engineer Bootcamp Progress

## Student

-   Goal: AI Engineer / ML Engineer / AI Platform Engineer
-   Main OS: Windows 11

## Overall Roadmap

### Month 1: Python for AI Engineer

-   Week 1: Python Basics
-   Week 2: OOP
-   Week 3: Production Python
...
Production ML (Redis, Celery, Qdrant)

### Month 6

Azure + AWS + Kubernetes + Portfolio
...
Copy this message:
    ...
    Continue my AI Engineer Bootcamp.
...
-   Project-based
-   GitHub every day
-   Senior code review after every assignment
-   Production-quality coding
-   Focus on AI Engineering instead of beginner Python only.
